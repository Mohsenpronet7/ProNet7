...
output_filename = "Mohsen_Pronet7.txt"
...
# ساخت HTML شکیل با تغییرات برای موبایل
html_content = f"""
<!DOCTYPE html>
<html lang="fa">
<head>
    ...
    <style>
        ...
        pre {{
            ...
            line-height: 1.4;      /* فاصله خطوط کمتر */
            overflow-x: auto;
            overflow-y: auto;
            max-height: 250px;     /* نصف کردن ارتفاع */
            margin-top: 15px;
        }}
        .qr {{
            margin: 25px 0;
...
<body>
    ...
    <a class="btn" href="{output_filename}" download>⬇️ دانلود فایل کامل ({output_filename})</a>
    <div class="qr">
